...
def upgrade():
    ...
    # Índices para tabela implantacoes
    # Melhora queries de dashboard e filtros
    ...
    # Índices para tabela gamificacao_metricas_mensais
...
def downgrade():
    ...
    # Helper para remover índice com segurança
    ...
    # Remove índices de implantacoes
