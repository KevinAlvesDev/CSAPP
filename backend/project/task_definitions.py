...
TASK_TIPS = {
    ...
    'módulo crm|operacional': "<div class='text-start'><div class='fw-semibold mb-1'>Checklist:</div><ul class='mb-0 ps-3'><li>Leads Hoje</li><li>Leads Acumuladas</li><li>Agend. Presenciais</li><li>Agendados de Amanhã</li><li>Visitantes 24h</li><li>Renovação</li><li>Desistentes</li><li>Indicações</li><li>Aluno Gympass</li><li>Grupo de Risco</li><li>Vencidos</li><li>Pós Venda</li><li>Faltosos</li><li>Aniversariantes</li><li>Indicações</li><li>Receptivo</li></ul></div>",
