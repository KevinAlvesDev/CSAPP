...
try:
    ...
    print(f"   GOOGLE_REDIRECT_URI: {'✅ Definido' if os.environ.get('GOOGLE_REDIRECT_URI') else '❌ Não definido'}")
    ...
    railway_vars = ['RAILWAY_PUBLIC_DOMAIN', 'RAILWAY_SERVICE_NAME', 'RAILWAY_ENVIRONMENT_NAME']
