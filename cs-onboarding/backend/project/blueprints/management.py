...
def manage_users():
    ...
    try:
        ...
        users_data = listar_usuarios_service(context=getattr(g, "modulo_atual", None), page=page)
        ...
        management_logger.error(f"Erro ao carregar a lista de usuários: {e}", exc_info=True)
...
def manage_users_modal():
    ...
    try:
        ...
        management_logger.error(f"Erro ao carregar conteúdo do modal de usuários: {e}", exc_info=True)
...
def update_user_profile():
    ...
    try:
        ...
        management_logger.error(f"Erro ao atualizar perfil de {usuario_alvo} por {g.user_email}: {e}", exc_info=True)
...
def update_user_perfil():
    ...
    if usuario_alvo is None:
        ...
        return redirect(url_for("management.manage_users", context=getattr(g, "modulo_atual", None)))
...
def delete_user():
    ...
    try:
        ...
        management_logger.error(f"Erro ao excluir usuário {usuario_alvo} por {g.user_email}: {e}", exc_info=True)
...
def cleanup_orphan_implantacoes():
    ...
    try:
        ...
        management_logger.error(f"Erro ao remover implantações órfãs por {g.user_email}: {e}", exc_info=True)
...
def clear_cache():
    ...
    try:
        ...
        management_logger.error(f"Erro ao limpar cache: {e}", exc_info=True)
