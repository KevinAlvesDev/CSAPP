from flask import render_template, g, request, flash, current_app, session, redirect, url_for
...
def dashboard():
    ...
    try:
        ...
        return render_template('pages/onboarding/dashboard.html', user_info=user_info, metrics={},
                               implantacoes_andamento=[], implantacoes_novas=[], error="Falha.")
...
def ver_implantacao(impl_id):
    ...
    try:
        ...
        return render_template(
            'pages/onboarding/implantacao_detalhes.html',
            **context_data
        )
