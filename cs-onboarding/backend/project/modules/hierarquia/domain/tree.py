...
def get_hierarquia_implantacao(implantacao_id):
    ...
    try:
        ...
        logger.error(f"[GET_HIERARQUIA] Erro ao buscar itens: {e}", exc_info=True)
    ...
    grupos_items: Dict[int, list[Any]] = {}

    tarefas_items: Dict[int, list[Any]] = {}

    subtarefas_items: Dict[int, list[Any]] = {}
    ...
    resultado: Dict[str, list[Any]] = {"fases": []}
        ...
        for grupo_item in grupos_fase:
            ...
            for tarefa_item in tarefas_grupo:
                ...
                if (
                    ...
                    or status_normalizado == "concluido"

                    or "conclui" in status_normalizado
