...
class ChecklistDataLoader:
    ...
    def _load_items(self) -> None:
        ...
        try:
            ...
            logger.error(f"Erro ao carregar checklist items para implantação {self.implantacao_id}: {e}", exc_info=True)
    ...
    def _load_comentarios(self) -> None:
        ...
        try:
            ...
            comentarios = (
                ...
                LEFT JOIN perfil_usuario p ON p.usuario = cc.autor
            ...
            logger.error(f"Erro ao carregar comentários para implantação {self.implantacao_id}: {e}", exc_info=True)
        ...
        for c in comentarios:
            if hasattr(c, "get"):
                ...
                try:
                    ...
                    logger.warning("ComentÃ¡rio sem item_id encontrado: %s", exc, exc_info=True)
                    continue
...
class ImplantacaoDataLoader:
    ...
    def load_all(self) -> dict[str, Any]:
        ...
        tarefas_agrupadas: OrderedDict[str, list[dict]] = OrderedDict()
