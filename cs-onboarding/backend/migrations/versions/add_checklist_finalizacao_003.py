...
def upgrade_postgres(cursor):
    ...
    templates_padrao = [
        ("Cliente confirmou go-live por email?", "Confirmação formal do cliente de que o sistema está pronto para uso", True, 1, True),
        ("Documentação técnica entregue?", "Manuais, guias e documentação do sistema foram enviados ao cliente", True, 2, True),
        ("Treinamento realizado e gravado?", "Sessão de treinamento foi realizada e gravação foi compartilhada", True, 3, True),
        ("Contatos de suporte compartilhados?", "Cliente recebeu informações de como obter suporte técnico", True, 4, True),
        ...
        ("Plano de contingência apresentado?", "Cliente foi informado sobre procedimentos em caso de problemas", False, 9, False),
...
def upgrade_sqlite(cursor):
    ...
    # Inserir templates padrão
    templates_padrao = [
        ("Cliente confirmou go-live por email?", "Confirmação formal do cliente de que o sistema está pronto para uso", 1, 1, 1),
        ("Documentação técnica entregue?", "Manuais, guias e documentação do sistema foram enviados ao cliente", 1, 2, 1),
        ("Treinamento realizado e gravado?", "Sessão de treinamento foi realizada e gravação foi compartilhada", 1, 3, 1),
        ...
        ("Plano de contingência apresentado?", "Cliente foi informado sobre procedimentos em caso de problemas", 0, 9, 0),
