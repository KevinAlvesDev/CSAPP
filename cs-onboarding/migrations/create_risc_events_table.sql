...
CREATE INDEX IF NOT EXISTS idx_risc_events_user_id ON risc_events(user_id);
CREATE INDEX IF NOT EXISTS idx_risc_events_event_type ON risc_events(event_type);
CREATE INDEX IF NOT EXISTS idx_risc_events_received_at ON risc_events(received_at);

-- Índice composto para queries comuns
CREATE INDEX IF NOT EXISTS idx_risc_events_user_type ON risc_events(user_id, event_type);
