"""
Script para aplicar a migração da tabela google_tokens.
Executa a criação da tabela para armazenar tokens do Google OAuth.
"""
...
def apply_migration():
    """Aplica a migração da tabela google_tokens."""
    
    migration_file = root_dir / 'migrations' / 'create_google_tokens_table.sql'
    ...
    try:
        ...
        with app.app_context():
            ...
            print("[INFO] Tabela 'google_tokens' criada.")
            return True
...
if __name__ == '__main__':
    print("=" * 60)
    print("Migracao: Criar tabela google_tokens")
    print("=" * 60)
